...
void biseccion(float x0, float x1,int n,float (*f)(float), float (*g)(float, float));
int main()
{
float x0, x1; int e, step = 1;
printf("\n Ingresar los 2 valores iniciales:\n"); scanf(" f f", &x0, &x1);
printf("Ingresar numero de veces:\n"); scanf(" d", &e);
/* metodo de biseccion */ biseccion(x0,x1,e,ftrig,ferrabs);
/* segunda funcion*/
printf("\n Ingresar los 2 valores iniciales:\n"); scanf(" f f", &x0, &x1);
printf("Ingresar numero de veces:\n"); scanf(" d", &e);

biseccion(x0,x1,e,flog,ferrabs); return 0;
}
